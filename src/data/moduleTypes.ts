...
export const MODULE_RARITY_WEIGHT: Record<ModuleRarity, number> = {
  common: 100,
  rare: 35,
  epic: 10,
}
...
export function getModuleById(id: string): ShipModule {
  const module = MODULE_TYPES.find(item => item.id === id)
